                    ...
                    <div class="col-sm-12">
						...
						<?php }?>
                                    ...
                                    <div class="tab-pane fade active show" id="basicinfo" role="tabpanel" aria-labelledby="basicinfo-tab">
									   		...
									   		<div class="form-group row">
												...
												<div class="col-sm-6">
	                                                ...
	                                                <input class="form-control" id="full_name_ch" type="text" required="" name="full_name_ch" placeholder="全名">
                                            ...
                                            <div class="form-group row">
											  	<div class="col-sm-6">
	                                                ...
	                                                <input class="form-control" id="from_organization" type="text" required="" name="from_organization" placeholder="Enter from organization">
													<div class="err_msg" id="err_from_organization"></div>
												</div>
												<div class="col-sm-6">
	                                                <label for="from_organization_ch" ><span>*</span> From Organization (Chinese)</label>
	                                                <input class="form-control" id="from_organization_ch" type="text" required="" name="from_organization_ch" placeholder="来自组织">
											...
											<div class="form-group row">
											  	<div class="col-sm-6">
													...
													<input class="form-control" id="charges_per_hourse" type="text" required="" name="charges_per_hourse" placeholder="Charges per Hours">
													<div class="err_msg" id="err_charges_per_hourse"></div>
												</div>
												<div class="col-sm-6">
	                                                <label for="charges_per_hourse_ch" ><span>*</span>Charges per Hours (Chinese)</label>
	                                                <input class="form-control" id="charges_per_hourse_ch" type="text" required="" name="charges_per_hourse_ch" placeholder="每小时收费">
											...
											<div class="form-group row">
											  	<div class="col-sm-6">
													...
													<input class="form-control" id="charges_per_visit" type="text" required="" name="charges_per_visit" placeholder="Charges per Visit">
													<div class="err_msg" id="err_charges_per_visit"></div>
												</div>
												<div class="col-sm-6">
	                                                <label for="charges_per_visit_ch" ><span>*</span>Charges per Visit (Chinese)</label>
	                                                <input class="form-control" id="charges_per_visit_ch" type="text" required="" name="charges_per_visit_ch" placeholder="每次访问费用">
                                ...
                                <div class="pull-right">
                                    <button type="submit" class="btn btn-primary custom-btn"  name="btn_save_doctor" id="btn_save_doctor">
									Add</button>
