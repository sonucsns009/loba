    ...
    <section class="sign-up-area pt-60 pb-60">
      <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="doctor-search-wrap">
                        <div class="doctor-search">
                            <input type="text" class="  search form-control" placeholder="Search" id="doctor_search" name="doctor_search" onkeypress="getDoctorSearchByName()" onkeydown="getDoctorSearchByName()"/>
                        </div>
                    </div>                        
            ...
            <div class="doctor-list-wrap">
                <div class="row" id="div_doctor_list"> 
                    <?php 
                        ...
                        <div class="Staff-detail-wraper">
                            <div class="Staff-img">
                                <?php if($row['doctor_image']!=""){?>
                                    <img src="<?php echo base_url().'uploads/doctor_images/'.$row['doctor_image'];?>" class="img-fluid">
                                <?php }else{?>
                            ...
                            <div class="Staff-containt">
                                <div class="Staff-basic-details">
                                    <div class="staff-left">
                                        <h5> <?php echo $row['doctor_full_name'];?> <!-- <span class="ratings"><i class="fa fa-star" aria-hidden="true"></i>5</span> --></h5>
                                        <p class="specility"><?php echo $row['specialization'];?></p>
                                    ...
                                    <div class="staff-right">
                                        ...
                                        <div class="staff-contact">
                                            <a href="<?php if(isset($category_id)){ echo base_url().'Doctor/bookDoctor/'.base64_encode($row['doctor_id']).'/'.base64_encode($category_id);}?>" class="btn theme-btn ">Book Now</a>
