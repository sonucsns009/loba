                    ...
                    <div class="col-lg-12">
                        <div class="Other-details">
                            <div class="row">
                                    ...
                                    <input type="hidden" name="nurse_id" id="nurse_id" value="<?php if (isset($doctorList)) {
                                                                                                        echo $doctorList['nurse_id'];
                                                                                                    } ?>">
                        ...
                        <a class="btn theme-btn mb-20 " href="#" onclick="showAddContent()"><span>Add Address</span></a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button class="btn theme-btn mb-20 " onclick="addNurseBooking()">Continue to Booking </button>
                                    </div>
                                </div>
                            </div>
